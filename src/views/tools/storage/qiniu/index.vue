  ...
  <div class="app-container" style="padding: 8px;">
    ...
    <div class="head-container">
      ...
      <el-dialog :visible.sync="dialog" :close-on-click-modal="false" append-to-body width="500px" @close="doSubmit">
        ...
        <el-cascader :options="options" label="分类"
                     @visible-change="xialaTruu($event)"
        ...
        <el-upload
          ...
          :file-list="fileList"
          :headers="headers"
          :data="{categoryId:selectedOptions}"
...
/*  cruds() {
  ...
  methods: {
    clickziyuan(val) {
      console.log("点击下拉框", val)
    },
    xialaTruu(e) {
      console.log("点击下拉框进来", e)
      if (e) {
        getimgcategory({type: 1, path:"/1/"}).then(res => {
          console.log("请求", res)
